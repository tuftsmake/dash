            ...
            x && (!1 !== d && setTimeout(y, 2E3), a.getJSON("http://tufts.doublemap.com/map/v2/buses?jsoncallback=?", function(d) {
                for (var b, a, f = 0, c = d.length; f < c; f++) {
                    ...
                    if (void 0 === r[b.id]) {
                        ...
                        var g = a = r[b.id] = b,
                            h = void 0,
                            h = void 0 === q[g.route] ? "/dash/map/img/colorize?img=bus_icon&color=333333&annotate=" : "/dash/map/img/colorize?img=bus_icon&color=" + q[g.route].color + "&annotate=" + q[g.route].short_name,
